    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (request.Url.Segments.Count() > 3 && request.Url.Segments[3].Contains("MyMethods"))
                {
                    responseString = Mymethods.displayParams(param1, param2);
                } else if (request.Url.Segments.Count() > 3 && request.Url.Segments[3].Contains("Executable"))
                {
                    responseString = Mymethods.Executable(param1, param2);
                } else
                {
